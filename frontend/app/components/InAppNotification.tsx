...
export const InAppNotification = () => {
  ...
  return (
    ...
    {inAppNotifications.length > 0 && (
        <View className="my-2 py-3 px-2 bg-[#10111908]
                         border-2 border-r-0 rounded-l-lg"
              style={{
                borderColor: inAppNotificationsJson[inAppNotifications[0].notificationTypeId].color || "#101119b0",
              }}
        >
          <Text className="text-md font-bold text-nowrap" 
                style={{
                  color: inAppNotificationsJson[inAppNotifications[0].notificationTypeId].color || "#101119b0",
                }}
          >
