...
export const TransactionUpgradeActions: React.FC<ActionsProps & { txId?: number, chainId?: number }> = ({
  locked,
  nextCost,
  onBuyPress,
  feeProps,
  ...
  const speedEnabled = speedProps !== undefined && !locked && isFirstTransaction;
  const enabled =
