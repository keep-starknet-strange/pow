...
import { getRandomNounsAttributes, getNounsHead, getNounsGlasses, getNounsBody, getNounsAccessories } from "../configs/nouns";
...
const LoadingDots = memo(() => {
  ...
  return (
    <View className="flex-row items-center justify-center my-[4px]">
      ...
      <Animated.Text style={dot1Style} className="text-[18px] font-Pixels text-gray-100">
        .
      </Animated.Text>
      <Animated.Text style={dot2Style} className="text-[18px] font-Pixels text-gray-100">
        .
      </Animated.Text>
      <Animated.Text style={dot3Style} className="text-[18px] font-Pixels text-gray-100">
        .
      </Animated.Text>
    </View>
  );
