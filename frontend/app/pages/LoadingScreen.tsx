...
console.log("isUserInitializing",isUserInitializing, "tutorialInitialized",tutorialInitialized, "account", account, "gameInitialized",gameInitialized, "balanceInitialized",balanceInitialized, "l2Initialized",l2Initialized, "achievementsInitialized",achievementsInitialized, "transactionsInitialized",transactionsInitialized, "upgradesInitialized",upgradesInitialized, "soundInitialized",soundInitialized);
