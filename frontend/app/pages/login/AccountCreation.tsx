      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        ...
        >
          ...
          >
            ...
            <TouchableOpacity
              className="flex items-center justify-center bg-[#ffff8010]
            ...
            <View className="flex flex-col items-start mt-8 w-screen px-8">
              <Text className="text-[#ffff80] text-md">Set up a username</Text>
            ...
            {creatingAvatar && (
              <View
                className="absolute left-0 right-0 bottom-0 bg-[#272727] rounded-t-3xl px-4 py-2 h-[29rem]
