      ...
      <View className="mb-5">
        <View className="bg-[#16161d] border border-[#39274E] rounded-b-md p-3">
          ...
          <View className="flex-row space-x-2 mb-3 ">
            <Text 
            className="flex-1 font-Pixels px-2 py-1 text-md text-[#fff7ff] rounded border"
            ...
            <View className="flex-1">
              <Text 
                className="font-Pixels px-2 py-1 text-md text-[#fff7ff] rounded border"
                style={{ borderColor: "#717171" }}
              >
                APR: {apr}%
              </Text>
            ...
            <View className="flex-row space-x-2 mb-3">
              <TouchableOpacity
                ...
                style={{ borderColor: "#717171" }}
              >
                <Text className="font-Pixels text-sm text-[#fff7ff]">
                  WITHDRAW
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
            ...
            <View className="flex-row items-center">
              <Text
                className="flex-1 px-3 py-2 rounded border bg-[#2c2c2e] font-Pixels text-sm"
        ...
        {/** === Stake your Bitcoin === */}
        <View className="mb-5">
          <View className="bg-[#39274E] rounded-t-md px-3 py-1">
            <Text className="font-Pixels text-xs uppercase text-[#fff7ff]">
              Stake your Bitcoin
            </Text>
          </View>
          <View className="bg-[#16161d] border border-[#39274E] rounded-b-md p-3">
            ...
            <View className="flex-row justify-between">
              {[1,2,3,4,5].map((i) => (
                <TouchableOpacity
                  ...
                  className="px-2 py-1 rounded border bg-[#2c2c2e]"
                  style={{ borderColor: "#717171" }}
                >
                  <Text className="font-Pixels text-xs text-[#fff7ff]">
                    {i * stakingIncrement}
                  </Text>
                </TouchableOpacity>
              ))}
        ...
        <View className="mb-4">
          ...
          >
            <Text className="font-Pixels text-lg text-[#fff7ff]">
