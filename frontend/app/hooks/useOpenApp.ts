...
async function openStore(iosId?: string, androidPkg?: string, androidPlayUrl?: string) {
...
function buildIntentUrl(primaryScheme: string | undefined, androidPackage?: string) {
...
export const WalletPresets = {
  braavos: {
    ...
    androidPlayUrl: 'https://play.google.com/store/apps/details?id=app.braavos.wallet',
  } satisfies AppTarget,
  ...
  readyWallet: {
    ...
    androidPlayUrl: 'https://play.google.com/store/apps/details?id=co.ready.wallet',
  } satisfies AppTarget,
};
